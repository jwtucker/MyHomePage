...
var windowActiveName="main";
  ...
  $(".project").hover(function(){
    var hoverTextDiv = $(this).find('div');
    var hoverText = hoverTextDiv.find('h1');
    hoverTextDiv.stop().fadeTo(600,.8);
    hoverText.stop().fadeTo(600,1);
  },function(){
    var hoverTextDiv = $(this).find('div');
    var hoverText = hoverTextDiv.find('h1');
    hoverTextDiv.stop().fadeTo(200,0);
    hoverText.stop().fadeTo(600,0);
  });
  ...
  $(function(){
      $(".screen").delay(4000).typed({
        ...
        "Please take a look at my completed projects","I think you'll be impressed","I'm capable with Backbone.js and Node.js", "I can make webapps and webpages", "Why are you still reading this?", "Click on that envelope to the left", "Or you can just hover over the buttons",
        "I do that a lot", "They're pretty neat" ,"A moose once bit my sister", "Mynd you, moose bites Kan be pretti nasti...", "I have to commend you on reading this far", "But seriously, go hire me", "So we can make cool webpages together"],
        typeSpeed: 40
      });
  });
  ...
  var testwindow = $(window);
    if (testwindow.height()<525 || testwindow.width()<630){
      console.log("trigger");
      $('body').html("<h1>Please make your browser a bit larger</h1>");
    }
